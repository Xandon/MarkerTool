...
, uGUI
    ...
    // not supported
        ...
        private bool SetupNextWave(TriggeredWaveSpecifics newWave, EventType eventType, int repetitionNumber = 0) {
            ...
            myCurrentWaveSize += (repetitionNumber * newWave.repeatItemInc.Value);
            ...
            timeToSpawnWave += repetitionNumber * newWave.repeatTimeInc.Value;
