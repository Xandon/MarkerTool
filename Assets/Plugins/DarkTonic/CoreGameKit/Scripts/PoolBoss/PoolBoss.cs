...
namespace DarkTonic.CoreGameKit {
	...
	private static PhotonView _view;
        ...
        /// </summary>
        /// <param name="transToDespawn">Transform to despawn</param>
        /// <param name="prefabName">Pass this in if you can from a constant. It will eliminate a little bit of Garbage Collection.</param>
		/// <returns>true if despawned</returns>
		public static bool Despawn(Transform transToDespawn, string prefabName = null) {
            if (!_isReady) {
                LevelSettings.LogIfNew(NotInitError);
                return false;
            }
    ...
    public static class PoolBossExtensions {
        ...
        /// <param name="prefabName"></param>
        /// <returns></returns>
        public static bool Despawn(this Transform transToDespawn, string prefabName = null) {
            return PoolBoss.Despawn(transToDespawn, prefabName);
        }
