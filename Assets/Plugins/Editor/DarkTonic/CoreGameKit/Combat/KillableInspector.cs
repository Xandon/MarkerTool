...
public class KillableInspector : Editor {
    ...
    public override void OnInspectorGUI() {
		...
		PoolBossEditorUtility.DisplayPrefab(ref _isDirty, _kill, ref trans, ref _kill.poolBossCategoryName, "Killable");
        ...
        text = "Deal Damage Prefab Settings";
            ...
            if (_kill.damagePrefabSpawnMode != Killable.DamagePrefabSpawnMode.None) {
                ...
                if (_kill.damageFireEvents) {
                    ...
                    if (GUILayout.Button(new GUIContent("Remove", "Click to remove the last Custom Event"), EditorStyles.toolbarButton, GUILayout.Width(50))) {
                        ...
                        _kill.damageCustomEvents.RemoveAt(_kill.damageCustomEvents.Count - 1);
                    }
                    GUI.contentColor = Color.white;
        ...
        if (_kill.showRespawnSettings) {
            ...
            if (_kill.respawnType != Killable.RespawnType.None) {
                ...
                if (_kill.respawnFireEvents) {
                    ...
                    if (GUILayout.Button(new GUIContent("Remove", "Click to remove the last Custom Event"), EditorStyles.toolbarButton, GUILayout.Width(50))) {
                        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _kill, "Remove last Damage Custom Event");
                        _kill.respawnCustomEvents.RemoveAt(_kill.respawnCustomEvents.Count - 1);
                    }
                    GUI.contentColor = Color.white;
